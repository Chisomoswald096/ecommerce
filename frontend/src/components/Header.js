    ...
    <nav className="navbar navbar-expand-lg navbar-light bg-light fixed-top">
      <div className="container-fluid">
        ...
        <div className="d-flex align-items-center">
          ...
          <a className="navbar-brand" href="/">MONTAGE EATREE<i className="fa fa-hamburger"></i> </a>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu" style={{ backgroundColor: "red", border: "none" }} aria-labelledby="navbarDropdown">
                ...
                {userInfo && <li><a className="dropdown-item" href="/adminproduct">Admin Product</a></li>}
